...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { badge_url: @badge.badge_url, image_url: @badge.image_url, remote_id: @badge.remote_id, skill: @badge.skill } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { badge_url: @badge.badge_url, image_url: @badge.image_url, remote_id: @badge.remote_id, skill: @badge.skill } }
